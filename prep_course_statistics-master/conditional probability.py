...
# initialize variables You are off to soccer and want to be the goalkeeper but that depends on who will be coaching today: with coach Sam, the probability of being the goalkeeper is 0.5 with coach Alex, the probability of being the goalkeeper is 0.3 You also know that Sam coaches more often – about six out of every ten games (a probability of 0.6).
